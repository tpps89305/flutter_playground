                      ...
                      actions: [
                        ...
                        TextButton(
                            onPressed: () => Navigator.pop(
                                context, locationRadioGroup.getSelectedItem()),
                            child: const Text("確定")),
                      ],
                    ));
                ...
                builder: (context) {
                  return SimpleDialog(
                    ...
                    children: [
                      SimpleDialogOption(
                          child:
                              const Text("小火龍", style: TextStyle(fontSize: 18)),
                          onPressed: () => Navigator.pop(context, "小火龍")),
                      SimpleDialogOption(
                        child:
                            const Text("傑尼龜", style: TextStyle(fontSize: 18)),
                        onPressed: () => Navigator.pop(context, "傑尼龜"),
                      ),
                      SimpleDialogOption(
                        child:
                            const Text("妙蛙種子", style: TextStyle(fontSize: 18)),
